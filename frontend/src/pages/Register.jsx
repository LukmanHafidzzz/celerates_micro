                ...
                <Row className='d-flex justify-content-center' data-aos="zoom-in" data-aos-duration='750'>
                    ...
                    <Col xl={5} className='p-5 bg-sc-container rounded-end-2'>
                        ...
                        <Form>
                            ...
                            <InputAuth label='Nama' placeholder='Masukan nama Anda' type='text' />
                            <InputAuth label='Password' placeholder='Masukan password Anda' type='password' />
                        </Form>
                        <div className='d-flex justify-content-center align-items-center gap-2 mb-4'>
                            <Form.Check />
                            <span className='fs-9'>Dengan membuat akun, Anda menyetujui Syarat dan Ketentuan</span>
                        </div>
                        <div className='mb-3'>
                            <Link to={'/home'}>
                                <Button className='fs-7 fw-medium auth-btn w-100' variant="outline-light">DAFTAR</Button>{' '}
                            </Link>
                        </div>
